...
public class DataManager {
	...
	public static void setPlayerData(String player, String DataName, String value) {
		...
		default:
			...
			if (r.getInt(1) == 0)
				SQLConnection
						.runQuery("INSERT INTO players (name, lvl, mana, exp, skills, class, heal, lastheal) VALUES ('"
								+ player + "', '0', '0.0', '0.0', '0', '', '20.0', '20.0');");

			SQLConnection
					.runQuery("UPDATE players SET " + DataName + " = '" + value + "' WHERE name = '" + player + "';");
...
try{
	...
	public static void RemoveClass(String classname) {
		...
		default:
          try{
			ResultSet r = SQLConnection.getResult("SELECT count(*) FROM classes WHERE classname = '" + classname + "';");
	        r.next();
